...
public class CounsellingAvailableStudentsNGOJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnAssignCounsellor.setBackground(new java.awt.Color(0, 51, 102));
        btnAssignCounsellor.setFont(new java.awt.Font("Adobe Devanagari", 1, 18)); // NOI18N
        btnAssignCounsellor.setForeground(new java.awt.Color(204, 204, 204));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnAssignCounsellor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(19, 19, 19))
        );
                    ...
                    for(Organization organisation : enterprise.getOrganizationDirectory().getOrganisationList())
                    {
                       for(UserAccount userAccount : organisation.getUserAccountDirectory().getUserAccountList())
                       {
                           if(userAccount.getUniqueId()== loggedinID)
                           {
                              ...
                              {
                                  if(workRequest.getEntryChildWorkRequest().isIsAccepted() &&workRequest.getEntryChildWorkRequest().getPerson().getAge()>17)
//                                      &&  workRequest.getCounsellor()==null
                                  {
