...
public class ReceptionistAdminJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnReceptionist.setBackground(new java.awt.Color(0, 51, 102));
        btnReceptionist.setFont(new java.awt.Font("Adobe Devanagari", 1, 14)); // NOI18N
        btnReceptionist.setForeground(new java.awt.Color(204, 204, 204));
        ...
        btnGraphRepresentation.setBackground(new java.awt.Color(0, 51, 102));
        btnGraphRepresentation.setFont(new java.awt.Font("Adobe Devanagari", 1, 14)); // NOI18N
        btnGraphRepresentation.setForeground(new java.awt.Color(204, 204, 204));
